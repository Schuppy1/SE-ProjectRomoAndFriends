...
public class ModernControlsArrowKeys : MonoBehaviour
{
    ...
    // fireball summoner
    public FireballSumonner2 summonFireBall;
    ...
    private void Start()
    {
        ...
        summonFireBall = FindFirstObjectByType<FireballSumonner2>();
    }
    ...
    private void ShortRangeCombo()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad1) && intervalReady)
        {
    ...
    private void MediumRangeCombo()
    {
        ...
        // Input
        if (Input.GetKeyDown(KeyCode.Keypad2) && intervalReady2)
        {
            if (comboStep2 == 0)
    ...
    private void LongRangeCombo()
    {
        ...
        // Input
        if (Input.GetKeyDown(KeyCode.Keypad3) && intervalReady3)
        {
            if (comboStep3 == 0)
